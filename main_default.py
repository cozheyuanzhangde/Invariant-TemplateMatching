...
if __name__ == "__main__":
    ...
    plt.show()
    points_list = invariant_match_template(rgbimage=img_rgb, rgbtemplate=cropped_template_rgb, method="TM_CCOEFF_NORMED", matched_thresh=0.5, rot_range=[0,360], rot_interval=10, scale_range=[100,150], scale_interval=10, rm_redundant=True, minmax=True)
